<?php
$questions = array (
   'Come state implementando la recente decisione della Corte di giustizia dell Unione europea (CGUE) relativa al diritto all oblio?' => array(
   ...
   'Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?' => array(
   ...
   'Perché il mio account è associato a un paese?' => array(
...
'Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?'=> array(
...
'Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?' => array(
